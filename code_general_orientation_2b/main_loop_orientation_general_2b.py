...
def computation(max_radius):
    ...
    vel_inf = 11.1111111E3 # 5.946E3 # m/s
...
if __name__ == '__main__':
    ...
    out_info.to_csv('./data/ds_orientation_general_2b_v1.txt', sep=',', index=False, header=False)

    # 获取文件名（含后缀）
    name = os.path.basename(__file__)
    path = os.getcwd()  # 获取当前工作目录路径
    mesg = 'Finish: ds_orientation_general_2b_v1'
