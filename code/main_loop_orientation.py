...
def gen_sample(Objpath, Objfile, alpha=0., beta=0., shapechange=0, fric=0., rstn=1.0, rstt=0.0):
    # Read OBJ data
...
if __name__ == '__main__':
    ...
    for i in range(RowNum):
        for j in range(ColNum):
            ...
            info = computation(max_radius,pos_p,vel_inf, trajType='general')
    ...
    out_info.to_csv('./data/ds_orientation_general_2b_test.txt', sep=',', index=False, header=False)
